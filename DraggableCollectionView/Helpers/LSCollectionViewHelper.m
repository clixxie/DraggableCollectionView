    ...
    switch (sender.state) {
        ...
        case UIGestureRecognizerStateCancelled: {
            ...
            if(self.layoutHelper.fromIndexPath == nil) {
                return;
            }else if ([self.layoutHelper.fromIndexPath isEqual: self.layoutHelper.hideIndexPath]) {
            ...
            */
            ...
            [UIView
             ...
             completion:^(BOOL finished) {
                 ...
                 self.layoutHelper.fromIndexPath = nil;
                 self.layoutHelper.toIndexPath = nil;
                 [self.collectionView reloadItemsAtIndexPaths:@[fromIndexPath,toIndexPath]];;
            ...
            NSInteger start = MIN(fromIndexPath.row, toIndexPath.row);
            NSInteger end = MAX(fromIndexPath.row, toIndexPath.row);
